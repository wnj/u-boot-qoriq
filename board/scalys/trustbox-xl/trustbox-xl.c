...
int checkboard(void)
{
	...
	switch (rev) {
	case 0x00:
		puts("Board: TrustBox XL, Rev: A, boot from ");
		break;
	case 0x01:
		puts("Board: TrustBox XL, Rev: B, boot from ");
		break;
	default:
		puts("Board: TrustBox XL, Rev: Unknown, boot from ");
		break;
	}
...
void config_board_mux(void)
{
	...
	/*
	 * TrustBox XL board has demultiplexer NX3DV42GU with GPIO3_23 as input
